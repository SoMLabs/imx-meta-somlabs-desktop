...
echo "BBLAYERS += \"\${BSPDIR}/sources/meta-nxp-desktop\"" >> $BUILD_DIR/conf/bblayers.conf
echo "BBLAYERS += \"\${BSPDIR}/sources/meta-somlabs-desktop\"" >> $BUILD_DIR/conf/bblayers.conf
...
echo "IMAGE_ROOTFS_SIZE = \"0\"" >> $BUILD_DIR/conf/local.conf
echo "IMAGE_OVERHEAD_FACTOR = \"1.3\"" >> $BUILD_DIR/conf/local.conf
